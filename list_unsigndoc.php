    ...
    <div class="wrapper">
      ...
      echo "<table class='table table-bordered'>";
        echo "<thead>" ;
         ...
         $sql = "SELECT * FROM unsigned_documents WHERE UID='$uid' order by ID DESC";
           ...
           echo "<tr>"; 
            ...
            //    $i ++;
             ...
             echo "<td align='center'>"; 
                ...
                echo "<a a href='signpendingdoc.php?docid=$docid';>";
                echo "<i class='fas fa-file-signature'></i>";
                
                echo  "</a>";
                
                
                echo "<a a style='padding-left:10px;' href='deleteunsign.php?id=$docid'>";
       ...
       ?>
        ...
        function getDocId(id) {
            ...
            ajaxRequest.open('GET', 'http://localhost:8080/JavaApi/rest/api/' + docId);
