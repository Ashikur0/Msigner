    ...
    <div class="wrapper">
      ...
      echo "<table class='table table-bordered'>";
        echo "<thead>" ;
         ...
         $sql = "SELECT ID,name FROM signed_documents WHERE UID='$uid'  order by ID DESC";
         ...
         while ($row  = $result->fetch_assoc()){
           ...
           echo "<tr>"; 
             ...
             echo "<td align='center'>"; 
               ...
               echo "<a href='view_signeddoc.php?id=$docid'>";
               echo  "<i class='fas fa-file-download'></i>";
                echo  "</a>";  

                echo "<a a style='padding-left:10px;' href='deletesigneddoc.php?id=$docid'>";
