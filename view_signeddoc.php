...
$sql = "SELECT name FROM signed_documents WHERE ID='$id' ";
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item mr-3">
          <form action="index.php" method="post"><button type="submit" class="btn btn-outline-primary">Home</button></form>
        </li>
  ...
  <div class="content-wrapper">
      ...
      <iframe src="files/signed_documents/<?php echo $doc; ?>" type='application/pdf' width='100%' height='700px'></iframe>
