...
$sql3 = "SELECT (ID) FROM signed_documents WHERE UID='$uid'";
$signdocresult = mysqli_query($conn, $sql3);
$signdoccount=mysqli_num_rows($signdocresult);
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="list_unsigndoc.php" class="small-box-footer">view <i
                        ...
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="viewcertinfo.php" class="small-box-footer">view <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <a href="list_signeddoc.php" class="small-box-footer">View <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
